      ...
      <Card className="w-lg">
        ...
        <CardContent>
          ...
          <div className="flex gap-2">
            ...
            <Badge className="cursor-pointer" variant="outline"><Check />Não finalizadas</Badge>
            <Badge className="cursor-pointer" variant="outline"><ArrowDownRight  />Concluídas</Badge>
          </div>
          ...
          <div className='flex justify-end items-center mt-2 gap-2'>
            <Sigma size={18}/>
            <p className='text-xs'>Três tarefas no total</p>
          </div>
